...
HD_PWD='G:/projet labo/code_synthese/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ldconv_cnn.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ldconv_cnn.tcl
